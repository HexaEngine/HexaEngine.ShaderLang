...
namespace HXSL
{
		...
		std::call_once(initFlag, []()
			{
				...
				Register<DummyStatementChecker, NodeType_FunctionCallStatement>();
	...
	void SwitchStatementChecker::HandleExpression(Analyzer& analyzer, TypeChecker& checker, SymbolResolver& resolver, SwitchStatement* statement)
	{
	...
	void CaseStatementChecker::HandleExpression(Analyzer& analyzer, TypeChecker& checker, SymbolResolver& resolver, CaseStatement* statement)
	{
